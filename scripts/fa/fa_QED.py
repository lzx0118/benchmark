...
# === 修改成你自己的路径 ===
BASE_DIR = r"<PATH_TO_XBENCH_ROOT>/fa\QED"
EN_FILE  = os.path.join(BASE_DIR, "QED.en-fa.en")
FA_FILE  = os.path.join(BASE_DIR, "QED.en-fa.fa")
OUT_FILE = os.path.join(BASE_DIR, "QED.en-fa.merged.tsv")
