...
# === 修改成你自己的路径 ===
BASE_DIR = r"<PATH_TO_XBENCH_ROOT>/fa\TEP"
EN_FILE  = os.path.join(BASE_DIR, "TEP.en-fa.en")
FA_FILE  = os.path.join(BASE_DIR, "TEP.en-fa.fa")
OUT_FILE = os.path.join(BASE_DIR, "TEP.en-fa.merged.tsv")
