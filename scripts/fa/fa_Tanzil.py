...
# === 修改成你自己的路径 ===
BASE_DIR = r"<PATH_TO_XBENCH_ROOT>/fa\Tanzil"
EN_FILE  = os.path.join(BASE_DIR, "Tanzil.en-fa.en")
FA_FILE  = os.path.join(BASE_DIR, "Tanzil.en-fa.fa")
OUT_FILE = os.path.join(BASE_DIR, "Tanzil.en-fa.merged.tsv")
