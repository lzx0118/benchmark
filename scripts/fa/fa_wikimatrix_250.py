...
# === 路径按你的实际情况修改 ===
BASE_DIR   = r"<PATH_TO_XBENCH_ROOT>/fa\wikimatrix"  # 自己改
INPUT_TSV  = os.path.join(BASE_DIR, "WikiMatrix.en-fa.merged.tsv")
OUTPUT_TSV = os.path.join(BASE_DIR, "WikiMatrix.en-fa.sample250.tsv")
