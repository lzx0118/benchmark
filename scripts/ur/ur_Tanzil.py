...
# === 修改成你自己的路径 ===
BASE_DIR = r"<PATH_TO_XBENCH_ROOT>/ur\Tanzil"
EN_FILE  = os.path.join(BASE_DIR, "Tanzil.en-ur.en")
UR_FILE  = os.path.join(BASE_DIR, "Tanzil.en-ur.ur")
OUT_FILE = os.path.join(BASE_DIR, "Tanzil.en-ur.merged.tsv")
