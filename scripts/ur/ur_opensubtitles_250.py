...
# === 路径按你的实际情况修改 ===
BASE_DIR   = r"<PATH_TO_XBENCH_ROOT>/ur\OpenSubtitles"  # 自己改成 ur 的目录
INPUT_TSV  = os.path.join(BASE_DIR, "OpenSubtitles.en-ur.merged.tsv")
OUTPUT_TSV = os.path.join(BASE_DIR, "OpenSubtitles.en-ur.sample250.tsv")
