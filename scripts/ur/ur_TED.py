...
# === 修改成你自己的路径 ===
BASE_DIR = r"<PATH_TO_XBENCH_ROOT>/ur\TED"
EN_FILE  = os.path.join(BASE_DIR, "TED2020.en-ur.en")
UR_FILE  = os.path.join(BASE_DIR, "TED2020.en-ur.ur")
OUT_FILE = os.path.join(BASE_DIR, "TED.en-ur.merged.tsv")
