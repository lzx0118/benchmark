...
# === 路径按你的实际情况修改 ===
BASE_DIR   = r"<PATH_TO_XBENCH_ROOT>/ur\QED"  # 自己改成 ur 的目录
INPUT_TSV  = os.path.join(BASE_DIR, "QED.en-ur.merged.tsv")
OUTPUT_TSV = os.path.join(BASE_DIR, "QED.en-ur.sample250.tsv")
