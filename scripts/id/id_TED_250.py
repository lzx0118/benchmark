...
# === 路径按你的实际情况修改 ===
BASE_DIR   = r"<PATH_TO_XBENCH_ROOT>/id\TED"          # 自己改成 id 的目录
INPUT_TSV  = os.path.join(BASE_DIR, "TED.en-id.merged.tsv")
OUTPUT_TSV = os.path.join(BASE_DIR, "TED.en-id.sample250.tsv")
