...
# === 修改成你自己的路径 ===
BASE_DIR = r"<PATH_TO_XBENCH_ROOT>/id\Tanzil"
EN_FILE  = os.path.join(BASE_DIR, "Tanzil.en-id.en")
ID_FILE  = os.path.join(BASE_DIR, "Tanzil.en-id.id")
OUT_FILE = os.path.join(BASE_DIR, "Tanzil.en-id.merged.tsv")
