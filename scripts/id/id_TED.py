...
# === 修改成你自己的路径 ===
BASE_DIR = r"<PATH_TO_XBENCH_ROOT>/id\TED"
EN_FILE  = os.path.join(BASE_DIR, "TED2020.en-id.en")
ID_FILE  = os.path.join(BASE_DIR, "TED2020.en-id.id")
OUT_FILE = os.path.join(BASE_DIR, "TED.en-id.merged.tsv")
