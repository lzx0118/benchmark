...
# === 路径按你的实际情况修改 ===
BASE_DIR   = r"<PATH_TO_XBENCH_ROOT>/ms\TED"  # 自己改成 ms 的目录
INPUT_TSV  = os.path.join(BASE_DIR, "TED.en-ms.merged.tsv")
OUTPUT_TSV = os.path.join(BASE_DIR, "TED.en-ms.sample250.tsv")
