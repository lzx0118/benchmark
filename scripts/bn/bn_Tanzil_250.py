...
# === 路径按你的实际情况修改 ===
BASE_DIR   = r"<PATH_TO_XBENCH_ROOT>/bn\Tanzil"  # 自己改
INPUT_TSV  = os.path.join(BASE_DIR, "Tanzil.bn-en.merged.tsv")
OUTPUT_TSV = os.path.join(BASE_DIR, "Tanzil.en-bn.sample250.tsv")
