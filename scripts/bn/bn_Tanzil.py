...
# === 修改成你自己的路径 ===
BASE_DIR = r"<PATH_TO_XBENCH_ROOT>/bn\Tanzil"
EN_FILE  = os.path.join(BASE_DIR, "Tanzil.bn-en.en")
BN_FILE  = os.path.join(BASE_DIR, "Tanzil.bn-en.bn")
OUT_FILE = os.path.join(BASE_DIR, "Tanzil.bn-en.merged.tsv")
