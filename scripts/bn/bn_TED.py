...
# === 修改成你自己的路径 ===
BASE_DIR = r"<PATH_TO_XBENCH_ROOT>/bn\TED"
EN_FILE  = os.path.join(BASE_DIR, "TED2020.bn-en.en")
BN_FILE  = os.path.join(BASE_DIR, "TED2020.bn-en.bn")
OUT_FILE = os.path.join(BASE_DIR, "TED.bn-en.merged.tsv")
