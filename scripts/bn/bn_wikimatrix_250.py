...
# === 路径按你的实际情况修改 ===
BASE_DIR   = r"<PATH_TO_XBENCH_ROOT>/bn\wikiMatrix"  # 自己改
INPUT_TSV  = os.path.join(BASE_DIR, "WikiMatrix.bn-en.merged.tsv")
OUTPUT_TSV = os.path.join(BASE_DIR, "WikiMatrix.bn-en.sample250.tsv")
