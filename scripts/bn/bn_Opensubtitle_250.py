...
# === 路径按你的实际情况修改 ===
BASE_DIR   = r"<PATH_TO_XBENCH_ROOT>/bn\Opensubtitle"  # 自己改
INPUT_TSV  = os.path.join(BASE_DIR, "OpenSubtitles.bn-en.merged.tsv")
OUTPUT_TSV = os.path.join(BASE_DIR, "OpenSubtitles.en-bn.sample250.tsv")
