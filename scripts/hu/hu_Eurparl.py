...
EN_FILE  = os.path.join(BASE_DIR, "Europarl.en-hu.en")
HU_FILE  = os.path.join(BASE_DIR, "Europarl.en-hu.hu")
OUT_FILE = os.path.join(BASE_DIR, "Europarl.en-hu.merged.tsv")
