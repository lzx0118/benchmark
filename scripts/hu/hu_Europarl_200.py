...
# ========= 路径 & 参数 =========
BASE_DIR   = r"<PATH_TO_XBENCH_ROOT>/hu\Europarl"
INPUT_TSV  = os.path.join(BASE_DIR, "Europarl.en-hu.merged.tsv")
OUTPUT_TSV = os.path.join(BASE_DIR, "Europarl.hu.sample200.tsv")

MAX_LINES         = 15000   # 只看前 1000 条（不含表头）
