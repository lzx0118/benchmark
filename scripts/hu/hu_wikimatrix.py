...
EN_FILE  = os.path.join(BASE_DIR, "WikiMatrix.en-hu.en")
HU_FILE  = os.path.join(BASE_DIR, "WikiMatrix.en-hu.hu")
OUT_FILE = os.path.join(BASE_DIR, "WikiMatrix.en-hu.merged.tsv")
