...
# === 修改成你自己的路径 ===
BASE_DIR = r"<PATH_TO_XBENCH_ROOT>/hu\QED"
EN_FILE  = os.path.join(BASE_DIR, "QED.en-hu.en")
HU_FILE  = os.path.join(BASE_DIR, "QED.en-hu.hu")
OUT_FILE = os.path.join(BASE_DIR, "QED.en-hu.merged.tsv")
