...
EN_FILE  = os.path.join(BASE_DIR, "OpenSubtitles.en-hu.en")
HU_FILE  = os.path.join(BASE_DIR, "OpenSubtitles.en-hu.hu")
OUT_FILE = os.path.join(BASE_DIR, "OpenSubtitles.en-hu.merged.tsv")
