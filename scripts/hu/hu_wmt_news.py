...
EN_FILE  = os.path.join(BASE_DIR, "WMT-News.en-hu.en")
HU_FILE  = os.path.join(BASE_DIR, "WMT-News.en-hu.hu")
OUT_FILE = os.path.join(BASE_DIR, "WMT-News.en-hu.merged.tsv")
